...
class Model:
    ...
    def _prepare_paths(self):
        ...
        self.path_to_samples_file = os.path.join(self.path_to_results_dir, "samples.gz")
    ...
    def get_generator_for_sample_file(
        ...
        with gzip.open(self.path_to_samples_file, "r") as fd:
            while True:
    ...
    def start_estimation(self, checkpoint_name: str) -> float:
        ...
        file_to_load = os.path.join(self.path_to_checkpoint_dir, str(self.n_samples))
        s = "[I] - The sample file exists"
        if not os.path.exists(file_to_load):
            s = "[I] - The sample file does not exist"
            self.start_eval(self.checkpoint_name)
        print(s)
